...
class MapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
        ...
        if lastAnnotation != nil {
            ...
            for annotation in mapView.annotations where annotation is SpeciesAnnotation {
                let currentAnnotation = annotation as! SpeciesAnnotation
                    if  Equal(currentAnnotation.coordinate, rhs: addedSpeciesCoordinate) {
    ...
    private func populateMap(){
        ...
        for result in results {
            ...
            let speciesAnnotation = SpeciesAnnotation(coordinate: coordinate, title: result.name, sub: category, species: result)
